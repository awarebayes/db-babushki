        ...
        <div class="w-96 mt-4">
            <Card>
                <div class="mb-2">
                    ...
                    <Textarea id="textarea-id" placeholder="Я уже джва году жду такую бабушку" rows="4" name="message" bind:value={review}/>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <ul class="items-center w-full rounded-lg border border-gray-200 sm:flex dark:bg-gray-800 dark:border-gray-600 divide-x divide-gray-200 dark:divide-gray-600">
                      <li class="w-full"><Radio name="hor-list" class="p-3" bind:group={rating} value={1}>1</Radio></li>
                      <li class="w-full"><Radio name="hor-list" class="p-3" bind:group={rating} value={2}>2</Radio></li>
                      <li class="w-full"><Radio name="hor-list" class="p-3" bind:group={rating} value={3}>3</Radio></li>
                      <li class="w-full"><Radio name="hor-list" class="p-3" bind:group={rating} value={4}>4</Radio></li>
                      <li class="w-full"><Radio name="hor-list" class="p-3" bind:group={rating} value={5}>5</Radio></li>
                    </ul>
                </div>
                <div class="">
                    <Button color="blue" on:click={submit_review}>
                        Оставить отзыв
                    </Button>
                </div>
            </Card>
