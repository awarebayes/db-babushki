...
describe("getGrandmas", () => {
  test("should return an array of grandmas", async () => {
    ...
    mockRepositories.grandmaRepository.getPaged = jest
      .fn()
      .mockResolvedValue(grandmas);
...
describe("getGrandmaWithUsername", () => {
  it("returns the grandma with the given username", async () => {
    ...
    mockRepositories.grandmaRepository.getWithUsername = jest
      .fn()
      .mockResolvedValue(grandma);
